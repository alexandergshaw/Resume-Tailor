      ...
      {mode === "roles" ? (
        ...
        <>
          ...
          >
            ...
            {/* AC-X1 headroom extraction: live mode's session control row —
                Start/Stop, the status pill, the clock, Auto-draft, Copy,
                Clear and the D6 "Download session log" control — moved
                VERBATIM to SessionControls.js (see that module's own doc).
                Every piece of state behind it still lives here. */}
            <SessionControls
              live={live}
              stop={stop}
